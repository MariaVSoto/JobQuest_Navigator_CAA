...
urlpatterns = [
    ...
    path('api/list/', views.job_list, name='job_list_func'),
    path('api/<uuid:pk>/', views.job_detail, name='job_detail_func'),
    path('api/search/', views.job_search, name='job_search_func'),
    path('api/nearby/', views.nearby_jobs, name='nearby_jobs_func'),
    path('api/map/', views.job_map, name='job_map_func'),
    path('api/saved/', views.saved_jobs, name='saved_jobs_func'),
    path('api/<uuid:pk>/save/', views.save_job, name='save_job_func'),
    path('api/<uuid:pk>/unsave/', views.unsave_job, name='unsave_job_func'),
    path('api/<uuid:pk>/apply/', views.apply_job, name='apply_job_func'),
    path('api/applications/', views.job_applications, name='job_applications_func'),
    path('api/skills/', views.skills, name='skills_func'),
    path('api/user-skills/', views.user_skills, name='user_skills_func'),
] 